...
import re
import logging
logging.basicConfig(filename='/var/ossec/logs/custom-virustotal-misp-syscheck.log', encoding='utf-8', level=logging.DEBUG)
...
def query_api(hash, apikey):
  ...
  if response.status_code == 200:
      ...
      alert_output["integration"] = "custom-virustotal-misp-syscheck"
...
def request_virustotal_info(alert, apikey):
    ...
    data = query_api(alert["data"]["misp"]["value"], apikey)
    ...
    alert_output["virustotal"]["source"]["file"] = alert["data"]["misp"]["value"]
